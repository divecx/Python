...
# Load the California Housing Datasets
...
plt.scatter(X_test[:, 0], ridge_predictions, color="green", label="Ridge Prediction", alpha=0.5)
plt.scatter(X_test[:, 0], lasso_predictions, color="orange", label="Lasso Prediction", alpha=0.5)
